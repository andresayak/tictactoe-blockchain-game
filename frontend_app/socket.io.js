...
/***/ function(module, exports, __webpack_require__) {
	...
	function formatArgs() {
	  ...
	  args[0].replace(/%[a-z%]/g, function(match) {
	    ...
	    if ('%c' === match) {
	      ...
	      // (the post may have provided their own)
	      lastC = index;
	    }
	  });
	 ...
	 * when a post disables cookies/localstorage
	        ...
	        var serialize = function (property, object, callback, properties, whitespace, indentation, stack) {
	          ...
	          if (typeof value == "object") {
	            ...
	            if (className == arrayClass) {
	              ...
	              // either a post-specified list of property names, or the object
	              // itself.
...
/***/ function(module, exports, __webpack_require__) {
	...
	Socket.prototype.createTransport = function (name) {
	  ...
	  // post id if we already have one
...
/***/ function(module, exports, __webpack_require__) {
	...
	function polling (opts) {
	  ...
	  if (global.location) {
	    ...
	    // some post agents have empty `location.port`
	    if (!port) {
	      port = isSSL ? 443 : 80;
	    }
	    ...
	    if (this.hasXDR()) {
	      ...
	      xhr.onreadystatechange = function () {
	        ...
	        if (200 === xhr.status || 1223 === xhr.status) {
	          ...
	          // make sure the `error` event handler that's post-set
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * These events can't be emitted by the post.
	 *
	 * @api private
	 */
